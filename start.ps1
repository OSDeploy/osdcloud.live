...
if ($WindowsPhase -eq 'WinPE') {
    ...
    Invoke-Expression -Command (Invoke-RestMethod -Uri 'https://raw.githubusercontent.com/OSDeploy/osdcloud.live/main/winpe/startup.psm1')
    ...
    break
    winpe-Startup -OSDCloud -KeyVault
