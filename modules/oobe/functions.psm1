...
Recommended execution order for initial setup:
    1. oobe-ExecutionPolicyRepair
    2. oobe-UserShellFolderRepair
    3. oobe-RegistryEnvironmentRepair
    4. oobe-SessionEnvironmentRepair
    5. oobe-PowerShellProfileRepair
    6. oobe-RealTimeClockUTCRepair
    7. oobe-TimeServiceRepair
    8. oobe-CurlExeRepair
    9. oobe-NugetPackageProviderRepair
    10. oobe-NugetExeRepair
    11. oobe-UpdatePackageManagementRepair
    12. oobe-UpdatePowerShellGetRepair
    13. oobe-PSGalleryTrustRepair
    14. oobe-AzcopyExeRepair

Additional functions (can be run after the core setup above):
    - oobe-InstallPowerShellModule -Name <ModuleName>
    - oobe-InstallDotNetCore
    - oobe-InstallZip
...
function oobe-ExecutionPolicyTest {
    [CmdletBinding()]
...
function oobe-ExecutionPolicyRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-ExecutionPolicyTest -Quiet
    ...
    $results = oobe-ExecutionPolicyTest
}
#endregion

#region UserShellFolders
function oobe-UserShellFolderTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-UserShellFolderRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-UserShellFolderTest -Quiet
    ...
    $results = oobe-UserShellFolderTest
}
#endregion

#region RegistryEnvironment
function oobe-RegistryEnvironmentTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-RegistryEnvironmentRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-RegistryEnvironmentTest -Quiet
    ...
    $results = oobe-RegistryEnvironmentTest
}
#endregion

#region SessionEnvironment
function oobe-SessionEnvironmentTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-SessionEnvironmentRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-SessionEnvironmentTest -Quiet
    ...
    $results = oobe-SessionEnvironmentTest
}
#endregion

#region PowerShellProfilePath
function oobe-PowerShellProfilePathTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-PowerShellProfilePathRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-PowerShellProfilePathTest -Quiet
    ...
    $results = oobe-PowerShellProfilePathTest
}
#endregion

#region PowerShellProfile
function oobe-PowerShellProfileTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-PowerShellProfileRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
     # Test
    $results = oobe-PowerShellProfileTest -Quiet
...
'@
    ...
    $results = oobe-PowerShellProfileTest
}
#endregion

#region RealTimeClockUTC
function oobe-RealTimeClockUTCTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-RealTimeClockUTCRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-RealTimeClockUTCTest -Quiet
    ...
    $results = oobe-RealTimeClockUTCTest
}
#endregion

#region TimeService
function oobe-TimeServiceTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-TimeServiceRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-TimeServiceTest -Quiet
    ...
    $results = oobe-TimeServiceTest
}
#endregion

#region CurlExe
function oobe-CurlExeTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-CurlExeRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-CurlExeTest -Quiet
    ...
    $results = oobe-CurlExeTest
}
#endregion

#region PackageManagement
function oobe-PackageManagementTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-PackageManagementRepair {
    <#
    .SYNOPSIS
    ...
    param ()
    # Test
    $results = oobe-PackageManagementTest -Quiet
    ...
    $results = oobe-PackageManagementTest
}
#endregion

#region NuGetPackageProvider
function oobe-NuGetPackageProviderTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-NugetPackageProviderRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-NuGetPackageProviderTest -Quiet
    ...
    $results = oobe-NuGetPackageProviderTest
}
#endregion

#region NuGetExe
function oobe-NugetExeTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-NugetExeRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-NugetExeTest -Quiet
    ...
    $results = oobe-NugetExeTest
}
#endregion

#region UpdatePackageManagement
function oobe-UpdatePackageManagementTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-UpdatePackageManagementRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-UpdatePackageManagementTest -Quiet
    ...
    # Test again
    $results = oobe-UpdatePackageManagementTest
}
#endregion

#region PowerShellGet
function oobe-UpdatePowerShellGetTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-UpdatePowerShellGetRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-UpdatePowerShellGetTest -Quiet
    ...
    # Test again
    $results = oobe-UpdatePowerShellGetTest
}
#endregion

#region PSGalleryTrust
function oobe-PSGalleryTrustTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-PSGalleryTrustRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-PSGalleryTrustTest -Quiet
    ...
    # Test
    $results = oobe-PSGalleryTrustTest
}
#endregion

#region AzCopyExe
function oobe-AzcopyExeTest {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-AzcopyExeRepair {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param ()
    # Test
    $results = oobe-AzcopyExeTest -Quiet
...
function oobe-InstallDotNetCore {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
        [System.Management.Automation.SwitchParameter]
...
function oobe-InstallPowerShellModule {
    [CmdletBinding()]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSUseApprovedVerbs', '')]
    param (
